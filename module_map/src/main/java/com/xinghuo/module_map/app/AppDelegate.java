package com.xinghuo.module_map.app;
...
import com.xinghuo.module_map.di.DaggerMapComponent;
import com.xinghuo.module_map.di.MapComponent;
...
public class AppDelegate extends CommonAppDelegate implements HasActivityInjector, HasServiceInjector {
    ...
    private MapComponent moduleComponent;
    ...
    public void bindSubComponent(BaseComponent baseComponent) {
        moduleComponent = DaggerMapComponent.builder()
    ...
    public MapComponent getAppComponent() {
