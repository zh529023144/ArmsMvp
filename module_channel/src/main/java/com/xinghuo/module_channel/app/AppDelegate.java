package com.xinghuo.module_channel.app;
...
import com.xinghuo.module_channel.di.ChannelComponent;
import com.xinghuo.module_channel.di.DaggerChannelComponent;
...
public class AppDelegate extends CommonAppDelegate implements HasActivityInjector, HasServiceInjector {
    ...
    private ChannelComponent moduleComponent;
    ...
    public void bindSubComponent(BaseComponent baseComponent) {
        moduleComponent = DaggerChannelComponent.builder()
    ...
    public ChannelComponent getAppComponent() {
