 ...
 */
package com.jess.xinghuo.base.delegate;
...
import com.jess.xinghuo.di.component.DaggerBaseComponent;
import com.jess.xinghuo.di.module.GlobalConfigModule;
import com.jess.xinghuo.integration.ConfigModule;
import com.jess.xinghuo.integration.ManifestParser;
 ...
 * ================================================
 */
public abstract class BaseAppDelegate implements IApp, AppLifecycles {
    private Application mApplication;
    protected BaseComponent mAppComponent;
    ...
    public BaseAppDelegate(@NonNull Context context) {
    ...
    public abstract void bindSubComponent(BaseComponent mAppComponent);
    ...
    /**
     * 将 {@link BaseComponent} 返回出去, 供其它地方使用, {@link BaseComponent} 接口中声明的方法返回的实例, 在 {@link #getBaseComponent()} 拿到对象后都可以直接使用
     *
     * @return AppComponent
    ...
    public BaseComponent getBaseComponent() {
        Preconditions.checkNotNull(mAppComponent,
                ...
                BaseComponent.class.getName(), getClass().getName(), Application.class.getName());
    ...
    private static class AppComponentCallbacks implements ComponentCallbacks2 {
        ...
        public AppComponentCallbacks(Application application, BaseComponent appComponent) {
            this.mApplication = application;
