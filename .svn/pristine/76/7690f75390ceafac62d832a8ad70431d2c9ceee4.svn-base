...
import com.jess.xinghuo.integration.ActivityLifecycle;
import com.jess.xinghuo.integration.cache.Cache;
import com.jess.xinghuo.integration.cache.LruCache;
...
public interface IActivity {
    ...
    /**
     * 初始化 View, 如果 {@link #bindLayout()} 返回 0, 框架则不会调用 {@link Activity#setContentView(int)}
     *
     * @return
     */
    int bindLayout();
     ...
     * 如果返回{@code false},那意味着这个 Activity 不需要绑定 Fragment,那你再在这个 Activity 中绑定继承于 {@link ArmsBaseFragment} 的 Fragment 将不起任何作用
