 ...
 */
package com.jess.xinghuo.utils;
...
import static com.jess.xinghuo.integration.AppManager.APP_EXIT;
import static com.jess.xinghuo.integration.AppManager.KILL_ALL;
import static com.jess.xinghuo.integration.AppManager.SHOW_SNACKBAR;
import static com.jess.xinghuo.integration.AppManager.START_ACTIVITY;
...
public class ArmsUtils {
    ...
    public static BaseComponent obtainAppComponentFromContext(Context context) {
        Preconditions.checkNotNull(context, "%s cannot be null", Context.class.getName());
        Preconditions.checkState(context.getApplicationContext() instanceof IApp, "Application does not implements App");
        return ((IApp) context.getApplicationContext()).getBaseComponent();
    }
