 ...
 */
package com.xinghuo.commonlib.common;
...
import com.xinghuo.commonlib.BuildConfig;
import com.xinghuo.commonlib.app.Constants.AppConst;
import com.xinghuo.commonlib.app.broadcast.BroadcastManager;
import com.xinghuo.commonlib.app.broadcast.ConnectionChangeReceiver;
import com.xinghuo.commonlib.app.network.CommonApiService;
import com.xinghuo.commonlib.app.util.NetworkUtil;
...
public class AppLifecyclesImpl implements AppLifecycles {
    ...
    static {
        ...
        SmartRefreshLayout.setDefaultRefreshFooterCreater((context, layout) -> new ClassicsFooter(context).setDrawableArrowSize(20));
    }
...
//        AppExceptionCatch.getInstance().init(application);
        RxJavaPlugins.setErrorHandler(throwable -> {
            Log.e("app", "err", throwable);
        });
...
//                    });
        ...
        ArmsUtils.obtainAppComponentFromContext(application)
                .extras()
                .put(IntelligentCache.KEY_KEEP + RefWatcher.class.getName(),
        ...
        AppConst.b_type = NetworkUtil.getConnectedType(application) == NetworkUtil.NetType.Mobile;
        if (AppConst.b_type){
        ...
        BroadcastManager.getInstance(application.getApplicationContext())
                .register(myReceiver, ConnectivityManager.CONNECTIVITY_ACTION);
    ...
    public void onTerminate(@NonNull Application application) {
        BroadcastManager.getInstance(application.getApplicationContext())
                .unregister(ConnectivityManager.CONNECTIVITY_ACTION);
    }
}
